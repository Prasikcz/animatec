    ...
    return (
        <header className="bg-dark d-flex justify-content-between align-items-center px-5 py-3">
            ...
            <div className="toolBar text-white d-flex flex-end gap-3">
                <Link to="/"><img src="/search.svg" alt="" title="Hledat" /></Link>
                <Link to="/"><img src="/app.svg" alt="" title="Aplikace" /></Link>
                <Link to="/"><img src="/settings.svg" alt="" title="Nastavení" /></Link>
                <Link to="/"><img src="/admin.png" alt="" title="Admin" /></Link>
                <Link to="/"><img src="/logout.png" alt="" title="Odhlásit se"/></Link>
            </div>
        </header>
    );
}
